...
namespace CodeSnippetsReflection.OpenAPI.Test
{
    public class GoGeneratorTests {
        ...
        public async Task GeneratesTheCorrectFluentAPIPathForIndexedCollections() {
            ...
            var snippetModel = new SnippetModel(requestPayload, ServiceRootUrl, await GetV1TreeNode());
            var result = _generator.GenerateCodeSnippet(snippetModel);
            Assert.Contains(".Me().Messages().WithMessageId(\"message-id\")", result);
        }
        [Fact]
        public async Task GeneratesTheCorrectFluentAPIPathForIndexedCollectionsWithMultipleParams() {
            ...
            var snippetModel = new SnippetModel(requestPayload, ServiceRootUrl, await GetV1TreeNode());
            var result = _generator.GenerateCodeSnippet(snippetModel);
            Assert.Contains("Drives().WithDriveId(\"drive-id\").Items().WithItemId(\"driveItem-id\").Checkin().", result);
        }
        [Fact]
        ...
        public async Task GeneratesThePatchMethodCall() {
            ...
            Assert.DoesNotContain("WithRequestConfigurationAndResponseHandler", result);
            Assert.Contains("graphClient.Me().Messages().WithMessageId(\"message-id\").Patch(context.Background(), requestBody, nil)", result);
        }
        [Fact]
        public async Task GeneratesThePutMethodCall() {
            ...
            Assert.DoesNotContain("WithRequestConfigurationAndResponseHandler", result);
            Assert.Contains("graphClient.Applications().WithApplicationId(\"application-id\").Logo().Put(context.Background(), requestBody, nil)", result);
        }
        [Fact]
        public async Task GeneratesTheDeleteMethodCall() {
            ...
            Assert.DoesNotContain("WithRequestConfigurationAndResponseHandler", result);
            Assert.Contains("graphClient.Me().Messages().WithMessageId(\"message-id\").Delete(context.Background(), nil)", result);
        }
        [Fact]
        ...
        public async Task GeneratesNestedParameterNames()
        {
            ...
            Assert.Contains("configuration :=", result);
            Assert.Contains("requestParameters :=", result);
            Assert.Contains("result, err := graphClient.Users().WithUserId(\"user-id\").Get(context.Background(), configuration)", result);
        }
        [Fact]
...
";
            ...
            Assert.Contains("graphClient.Groups().WithGroupId(\"group-id\").Members().Ref().Post(context.Background(), requestBody, nil)", result);
        }
        [Fact]
        ...
        public async Task SupportsODataOldIndexFormat() {
            ...
            var result = _generator.GenerateCodeSnippet(snippetModel);
            Assert.Contains("graphClient.Me().Events().WithEventId(\"event-id\").Attachments().Post(context.Background(), requestBody, nil)", result);
        }
        [Fact]
        public async Task ParsesThePayloadEvenIfContentTypeIsMissing() {
            ...
            var result = _generator.GenerateCodeSnippet(snippetModel);
            Assert.Contains("graphClient.Teams().WithTeamId(\"team-id\").Channels().WithChannelId(\"channel-id\").Messages().Post(context.Background(), requestBody, nil)", result);
        }
        [Fact]
        ...
        **/
        ...
        public async Task DoesntFailOnTerminalSlash() {
            ...
            var snippetModel = new SnippetModel(requestPayload, ServiceRootBetaUrl, await GetBetaTreeNode());
            var result = _generator.GenerateCodeSnippet(snippetModel);
            Assert.Contains("graphClient.Me().Messages().WithMessageId(\"message-id\").Get(context.Background(), configuration)", result);
        }
        [Fact]
